   ...
   <div class="p-grid">   <!--pcgrid用-->
      ...
      <main class="l-main p-main">
         ...
         <div class="p-subheading-card">   <!--小見出し~カードのくくり padding用-->
            ...
            <section> <!--カード-->
               <figure class="p-card">
                  <img src="images/archive-card.png" alt="検索結果" class="p-card-img">
                  <div class="p-archive-card">
                     <div class="p-card__wrapper"> 
                        <h3 class="c-title p-card__wrapper__img-caption">見出しが入ります1</h3>
               ...
               <figure class="p-card">
                  ...
                  <div class="p-archive-card">
                     <div class="p-card__wrapper"> 
                        <h3 class="c-title p-card__wrapper__img-caption">見出しが入ります2</h3> <!--c-titleクラス名変える-->
                        <h4 class="c-title p-card__wrapper__subtitle">小見出しが入ります</h4>
                        <figcaption class="c-text p-card__wrapper__text">テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。
                        </figcaption>    
                     </div>     <!--wrapper-->        
               ...
               <figure class="p-card">
                  ...
                  <div class="p-archive-card">
                     <div class="p-card__wrapper"> 
                        <h3 class="c-title p-card__wrapper__img-caption">見出しが入ります3</h3> <!--c-titleクラス名変える-->
                        <h4 class="c-title p-card__wrapper__subtitle">小見出しが入ります</h4>
                        <figcaption class="c-text p-card__wrapper__text">テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。
                        </figcaption>    
                     </div>     <!--wrapper-->        
               ...
               <figure class="p-card">
                  ...
                  <div class="p-archive-card">
                     <div class="p-card__wrapper"> 
                        <h3 class="c-title p-card__wrapper__img-caption">見出しが入ります4</h3> <!--c-titleクラス名変える-->
                        <h4 class="c-title p-card__wrapper__subtitle">小見出しが入ります</h4>
                        <figcaption class="c-text p-card__wrapper__text">テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。
                        </figcaption>    
                     </div>     <!--wrapper-->        
               ...
               <figure class="p-card">
                  ...
                  <div class="p-archive-card">
                     <div class="p-card__wrapper"> 
                        <h3 class="c-title p-card__wrapper__img-caption">見出しが入ります5</h3> <!--c-titleクラス名変える-->
                        <h4 class="c-title p-card__wrapper__subtitle">小見出しが入ります</h4>
                        <figcaption class="c-text p-card__wrapper__text">テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。
                        </figcaption>    
                     </div>     <!--wrapper-->        
